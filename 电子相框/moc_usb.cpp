...
**
** Created: Fri May 19 08:16:23 2017
...
static const char qt_meta_stringdata_USB[] = {
    "USB\0"
};
...
const QMetaObjectExtraData USB::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject USB::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_USB,
      qt_meta_data_USB, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &USB::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_USB))
        return static_cast<void*>(const_cast< USB*>(this));
