...
namespace WindowsFormsApplication1
{
    class StressTest
    {
        ...
        private void CalculateAll(DataTable datatable)
        {
            ...
            dataView.Sort = "Column6 DESC";
            //从大到小排序后的表
            DataTable datatable_sort = dataView.ToTable();
            DataRow[] dataRow_jiaoyun_7 = datatable_sort.Select("Column4 LIKE '%胶带%' and Column4 LIKE '%7米%'");
            DataRow[] dataRow_jiaoyun_12 = datatable_sort.Select("Column4 LIKE '%胶带%' and Column4 LIKE '%12米%'");
            DataRow[] dataRow_fuyun_7 = datatable_sort.Select("Column4 LIKE '%回风%'and Column4 LIKE '%7米%'");
            DataRow[] dataRow_fuyun_12 = datatable_sort.Select("Column4 LIKE '%回风%'and Column4 LIKE '%12米%'");
